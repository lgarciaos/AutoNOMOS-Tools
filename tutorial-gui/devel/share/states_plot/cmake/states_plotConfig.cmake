...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'states_plot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotica/AutoNOMOS-Tools/tutorial-gui/src/opencv_gui/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robotica/AutoNOMOS-Tools/tutorial-gui/devel/lib;/home/robotica/EK_AutoNOMOS/devel/lib;/home/robotica/AutoNOMOS/devel/lib;/opt/ros/kinetic/lib)
